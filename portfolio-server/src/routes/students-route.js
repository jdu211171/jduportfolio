 ...
 *   get:
 *     tags: [Students]
 *     summary: Get student with credit details
 *     parameters:
 *       - in: path
 *         name: studentId
 *         required: true
 ...
 *     responses:
 *       200:
 *         description: Student with credit details
 *       404:
 *         description: Student not found
 */
// GET /api/students/:studentId/credit-details
router.get(
	'/:studentId/credit-details',
	StudentController.getStudentWithCreditDetails
)
 ...
 *   post:
 *     tags: [Students]
 *     summary: Sync credit details from Kintone for a specific student
 *     parameters:
 *       - in: path
 *         name: studentId
 *         required: true
 ...
 *         description: Student not found
 */
// POST /api/students/:studentId/sync-credit-details
router.post(
	'/:studentId/sync-credit-details',
	StudentController.syncStudentCreditDetails
)

/**
 * @swagger
 * /api/students/sync-all-credit-details:
 *   post:
 *     tags: [Students]
 *     summary: Sync credit details from Kintone for all active students
 *     responses:
 *       200:
 *         description: Credit details synced for all students
 */
// POST /api/students/sync-all-credit-details
router.post(
	'/sync-all-credit-details',
	StudentController.syncAllStudentCreditDetails
)
