	...
	Student.init(
		{
			...
			hobbies_description: { type: DataTypes.TEXT, allowNull: true },
			special_skills_description: { type: DataTypes.TEXT, allowNull: true },
			education: { type: DataTypes.JSONB, allowNull: true, defaultValue: [] },
			work_experience: { type: DataTypes.JSONB, allowNull: true, defaultValue: [] },
			licenses: { type: DataTypes.JSONB, allowNull: true, defaultValue: [] },
			additional_info: { type: DataTypes.JSONB, allowNull: true },
			arubaito: { type: DataTypes.JSONB, allowNull: true, defaultValue: [] },
			address_furigana: { type: DataTypes.STRING, allowNull: true },
