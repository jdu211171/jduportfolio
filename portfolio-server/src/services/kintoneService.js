  ...
  static async syncData() {
    try {
      ...
      const formattedStudentData = students.map((record) => ({
        ...
        jlpt: JSON.stringify(
          jlptData[record.studentId.value] ? jlptData[record.studentId.value] : ''
        ),
        jdu_japanese_certification: JSON.stringify(
          jduJlptData[record.studentId.value] ? jduJlptData[record.studentId.value] : ''
        ),
        ielts: JSON.stringify(
          ieltsData[record.studentId.value] ? ieltsData[record.studentId.value] : ''
        ),
        japanese_speech_contest: JSON.stringify(
          benronData[record.studentId.value] ? benronData[record.studentId.value] : ''
        ),
        it_contest: JSON.stringify(
          itContestData[record.studentId.value] ? itContestData[record.studentId.value] : ''
        ),
      }))
