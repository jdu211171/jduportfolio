...
module.exports = {
	...
	async down(queryInterface, Sequelize) {
		const table = 'Recruiters'
		const cols = ['japanese_level', 'application_requirements_other', 'retirement_benefit', 'telework_availability', 'housing_availability', 'relocation_support', 'airport_pickup', 'intro_page_thumbnail']
		for (const c of cols) {
			try {
