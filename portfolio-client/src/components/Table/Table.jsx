                    ...
                    (header) =>
                      ...
                      (header.visibleTo ? header.visibleTo.includes(role) : true) && (
                        <TableCell
                          ...
                          onClick={() => (header.onClickAction ? header.onClickAction(row) : null)}
                          className={header.onClickAction ? style.hoverEffect : style.default}
                          style={{
                            minWidth: header.minWidth,
                            padding: header.type === 'avatar' ? '4px' : undefined,
                            ...(header.type === 'action'
                              ? {
                                  position: 'sticky',
                                  right: 0,
                                ...
                                {header.options.map((option, key) => {
                                  ...
                                  return (
                                    <MenuItem
                                      ...
                                      onClick={() =>
                                        handleClose(
                                          option.visibleTo === 'Admin' ? row.id : row.draft.id,
                                          option.action
                                        )
                                      }
                                      sx={shouldBeVisible ? {} : { display: 'none' }}
                                    >
                                      {option.label}
                                    </MenuItem>
                                  )
