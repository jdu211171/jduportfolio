    ...
    <div className={styles.container}>
          ...
          <tr className={styles.row}>
            ...
            <td className={styles.cell}>
              {editMode ? (
                ...
                <div className={styles.cell}>{newData[activeDeliverable]?.title}</div>
              )}
            </td>
          </tr>
          <tr className={styles.row}>
      ...
      <Box className={styles.imageBox}>
        ...
        <TransformWrapper>
          <TransformComponent>
            <img
              src={imagePreview[activeDeliverable] || newData[activeDeliverable]?.imageLink}
        ...
        {newData.map(
          (pr, index) =>
            activeDeliverable !== index && (
              ...
              >
                {pr.title}
                <img src={imagePreview[index] || pr.imageLink} alt={pr.title || `Image ${index}`} />
                {editMode && (
                  <IconButton
                    onClick={(e) => {
                      e.stopPropagation()
