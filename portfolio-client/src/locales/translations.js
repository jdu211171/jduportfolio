const translations = {
	en: {
		...
		enterYourInfo: 'Please enter your information!',
		login: 'Login',
		enterYourLogin: 'Please enter your login',
		enterYourPassword: 'Please enter your password',
		save: 'Save',
		forgotPassword: 'Forgot your password?',
		resetPassword: 'A password reset link will be sent to',
		resetPassword2: 'your email.',
		mailAddress: 'Email address',
		enterYourEmai: 'Please enter your email',
		send: 'Send',
		back: 'Back',
	},
	ja: {
		...
		draft: '未申請',
		welcome: 'おかえりなさい!',
		enterYourInfo: '情報をご入力ください!',
		login: 'ログイン',
		enterYourLogin: 'ログインをご入力ください',
		enterYourPassword: 'パスワードをご入力ください',
		save: '保存',
		forgotPassword: 'パスワードをお忘れですか',
		resetPassword: 'パスワード変更用リンクを電子メールに',
		resetPassword2: '送信します',
		mailAddress: 'メールアドレス',
		enterYourEmai: 'メールをご入力ください',
		send: '送信',
		back: '戻る',
	},
	uz: {
		...
		login: 'Kirish',
		enterYourLogin: 'Kirish ma’lumotlarini kiriting',
		enterYourPassword: 'Parolingizni kiriting',
		save: 'Saqlash',
		forgotPassword: 'Parolingizni unutdingizmi?',
		resetPassword: 'Parolni o‘zgartirish havolasi elektron',
		resetPassword2: ' pochtangizga yuboriladi.',
		mailAddress: 'Elektron pochta manzili',
		enterYourEmai: 'Elektron pochtangizni kiriting',
		send: 'Yuborish',
		back: 'Ortga',
	},
}
