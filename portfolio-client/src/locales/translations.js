const translations = {
	en: {
		...
		EditNews: 'Edit news',
		visibleToRecruiter: 'Visible to recruiter',
		newsVisibility: 'News Visibility',
		universityNews: 'University News',
		universityNewsDescription: 'Visible to everyone',
		recruiterNews: 'Recruiter News',
		recruiterNewsDescription: 'Visible to non-recruiters',
		...
		kyoto_tachibana_university: 'Kyoto Tachibana University',
		sanno_university: 'Sanno University',
		sanno_junior_college: 'Sanno Junior College (Jiyugaoka)',
		...
		lessThanThreeYears: 'Less than three years',
		basic: 'Basic',
		...
		noSkillsEdit: 'No skills added yet. Use the form above to add skills.',
...
<li>Being involved with anti-social forces, providing benefits to or using such forces, or maintaining inappropriate relationships with them, or engaging in acts likely to lead to such outcomes</li>
		...
		allowances_placeholder: 'Enter other allowances (welfare)',
		...
		no_intro_pages_set: 'No intro pages have been set',
	...
	ja: {
		...
		CreateNews: 'ニュース作成',
		EditNews: 'ニュース変更',
		visibleToRecruiter: 'リクルーターに表示',
		newsVisibility: 'ニュース表示設定',
		universityNews: '大学ニュース',
		universityNewsDescription: '全員に表示',
		recruiterNews: 'リクルーターニュース',
		recruiterNewsDescription: 'リクルーター以外に表示',
		imageRequired: '画像は必須です',
		descriptionRequired: '説明は必須です',
		fillRequiredFields: '必須項目（タイトル、説明、画像）を入力してください',
		cencel: 'キャンセル',
		searchByHashtag: 'ハッシュタグ、会社名、ニュースのタイトルで検索します...',
		checkOut: 'ニュース一覧',
		newsHighlights: 'ニュース一覧',
		news: 'ニュース',
		...
		loadMore: 'もっと見る',
		newsDetails: 'ニュース詳細',
		confirmMarkAllRead: 'すべてのニュースを既読にしますか？',
		allNewsMarkedRead: 'すべてのニュースを既読にしました。',
		...
		all: 'すべて',
		search_items: '検索...',
		select_all_filtered: 'すべて選択（絞り込み）',
		clear_filtered: 'クリア（絞り込み）',
		selected: '選択済み',
		select_all: 'すべて選択',
		clear_all: 'すべて解除',
		jlpt: '日本語能力試験',
		...
		kyoto_tachibana_university: '京都橘大学',
		sanno_university: '産業能率大学',
		sanno_junior_college: '自由が丘産能短期大学',
		niigata_sangyo_university: '新潟産業大学',
		otemae_university: '大手前大学',
		okayama_university_of_science: '岡山理科大学',
		student: '学生',
		rows_per_page: '表示件数:',
		search: '検索',
		reset: '戻る',
		...
		noSkillsEdit: 'スキルがまだ追加されていません。上のフォームから追加してください。',
...
<li>反社会的勢力等に関連する組織に属する行為、反社会的勢力に利益を与え、または利用する等不適切な関係を持つ行為、もしくはそれらのおそれのある行為</li>
		...
		// CompanyProfile page translations
		business_content_placeholder: '事業内容',
		recruitment_requirements: '募集要件',
		target_person: '対象者',
		target_audience_placeholder: '対象者',
		additional_info: '追加情報',
		work_location_placeholder: '勤務地',
		work_hours: '勤務時間',
		work_hours_placeholder: '勤務時間',
		salary_placeholder: '給与',
		benefits_placeholder: '社会保険',
		allowances_placeholder: 'その他手当・福利厚生',
		selection_process_placeholder: '採用までの流れ',
		established: '設立',
		...
		no_files_uploaded: '資料が設定されていません',
		no_intro_pages_set: 'ページが設定されていません',
	...
	uz: {
		...
		visibleToRecruiter: 'Ish beruvchiga ko‘rinadigan',
		...
		imageRequired: 'Rasm majburiy',
		descriptionRequired: 'Tavsif majburiy',
		fillRequiredFields: 'Iltimos, barcha majburiy maydonlarni to‘ldiring (Sarlavha, Tavsif, Rasm)',
		cencel: 'Bekor qilish',
		...
		select_all_filtered: 'Hammasini tanlash (filtrl.)',
		clear_filtered: 'Tozalash (filtrl.)',
		selected: 'Tanlangan',
		select_all: 'Hammasini tanlash',
		clear_all: 'Hammasini bekor qilish',
		...
		yes: 'Ha',
		no: "Yo'q",
		tokyo_communication_university: 'Tokio aloqa universiteti',
		kyoto_tachibana_university: 'Kioto Tachibana universiteti',
		sanno_university: 'Sanno universiteti',
		sanno_junior_college: 'Sanno qisqa muddatli kollej',
		niigata_sangyo_university: 'Niigata sanoat universiteti',
		otemae_university: 'Otemae universiteti',
		okayama_university_of_science: 'Okayama fan-texnika universiteti',
		student: 'Talaba',
		...
		liveProfile: 'Jonli profil',
		draftProfile: 'Qoralama profil',
		...
		lessThanThreeYears: 'Uch yildan kam',
		basic: 'Asosiy',
		loading: 'Yuklanmoqda...',
		save: 'Saqlash',
		cancel: 'Bekor qilish',
		...
		noSkillsEdit: "Hali ko'nikmalar qo'shilmagan. Yuqoridagi formadan qo'shing.",
...
<li>Antisotsial kuchlar bilan bog‘liq tashkilotlarga mansub bo‘lish, antisotsial kuchlarga foyda keltirish yoki ulardan foydalanish kabi nojo‘ya munosabatlarga ega bo‘lish xatti-harakati yoki bunga olib kelishi mumkin bo‘lgan xatti-harakatlar</li>
		...
		allowances_placeholder: "Boshqa to'lovlar va imtiyozlarni kiriting",
		...
		no_intro_pages_set: 'Hali sahifalar belgilanmagan',
		...
		newest: 'Yangi avval',
		oldest: 'Eski avval',
		searchNewsPlaceholder: 'Yangiliklarni qidiring...',
	...
	ru: {
		...
		visibleToRecruiter: 'Показывать рекрутеру',
		...
		fillRequiredFields: 'Пожалуйста, заполните все обязательные поля (Заголовок, Описание и Изображение)',
		cencel: 'Отмена',
		...
		all: 'Все',
		search_items: 'Поиск...',
		select_all_filtered: 'Выбрать все (фильтр)',
		clear_filtered: 'Очистить (фильтр)',
		selected: 'Выбрано',
		...
		kyoto_tachibana_university: 'Университет Киото Тачибана',
		sanno_university: 'Университет Санно',
		sanno_junior_college: 'Краткосрочный колледж Санно',
		niigata_sangyo_university: 'Ниигатский промышленный университет',
		otemae_university: 'Университет Отэмаэ',
		okayama_university_of_science: 'Университет науки Окаямы',
		student: 'Студент',
		...
		lessThanThreeYears: 'Менее трёх лет',
		basic: 'Базовый',
		...
		noSkillsEdit: 'Навыки ещё не добавлены. Используйте форму выше, чтобы добавить навыки.',
		...
		allowances_placeholder: 'Введите другие надбавки и льготы',
		...
		no_intro_pages_set: 'Страницы еще не установлены',
		...
		searchNewsPlaceholder: 'Поиск новостей...',
		loadMore: 'Показать еще',
		newsDetails: 'Подробнее о новости',
		confirmMarkAllRead: 'Отметить все новости как прочитанные?',
		allNewsMarkedRead: 'Все новости помечены как прочитанные.',
