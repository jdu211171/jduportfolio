...
const Top = () => {
  ...
  const handleGalleryUpdate = (files, isNewFiles = false, isDelete = false, parentKey = null) => {
    if (isNewFiles && !isDelete) {
      ...
      if (isNewFiles) {
        ...
        const oldFiles = parentKey ? [...editData[parentKey].gallery] : [...editData.draft.gallery]
  ...
  return (
    <Box my={2}>
      <>
        {subTabIndex !== 2 &&
          ReactDOM.createPortal(portalContent, document.getElementById('saveButton'))}
      </>
