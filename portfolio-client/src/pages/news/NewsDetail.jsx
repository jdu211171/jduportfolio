...
export const NewsDetail = () => {
	...
	return (
		<div style={{ maxWidth: 900, margin: '0 auto', padding: 16 }}>
			...
			<div className={styles.detailImage}>{item.image_url ? <img className={styles.img} src={item.image_url} alt={item.title} loading='lazy' decoding='async' /> : <div className={styles.noImage}>{t('noImageAvailable')}</div>}</div>
			...
			<p className={styles.descText} style={{ marginTop: 12 }}>
				{item.description}
			</p>
