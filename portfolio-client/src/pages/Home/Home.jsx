      ...
      <div className={styles.container}>
        ...
        <div className={styles.mainImages}>
          <div className={styles.mainImage}>
            <div style={{ fontWeight: 600, fontSize: '22px', textAlign: 'center' }}>
              私たちの大学
            </div>
          ...
          <div className={styles.mainImage}>
            ...
            <div>
              Japan Digital University is an official private university established and operated in
              Uzbekistan. We call our satellite campus in Uzbekistan JDU. Students in Uzbekistan
              participate in classes at affiliated Japanese universities online, take exams at
              Japanese universities, and aim to earn credits and graduate. (It is possible to
              graduate with degrees from both Japan and Uzbekistan.) Upon graduation, students aim
              to find employment at Japanese companies, and many students enroll every year.
            </div>
          </div>
        </div>
      </div>
