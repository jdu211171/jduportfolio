...
const Student = ({ OnlyBookmarked = false }) => {
	...
	const headers = [
		...
		},
		{
			...
			minWidth: '100px',
			statusMap: {
				draft: { icon: 'rejected', color: '#f44336', text: '未承認' },
				submitted: { icon: 'pending', color: '#ff9800', text: '未承認' },
				checking: { icon: 'pending', color: '#ff9800', text: '未承認' },
				resubmission_required: {
					icon: 'rejected',
					color: '#f44336',
					text: '差し戻し',
				},
				disapproved: { icon: 'rejected', color: '#f44336', text: '差し戻し' },
				approved: { icon: 'approved', color: '#4caf50', text: '承認済' },
			},
		},
		{
